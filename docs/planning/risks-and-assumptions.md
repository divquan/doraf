...
| R-101 | A Supabase database backup is assumed to include Storage objects. | Dispute evidence or exports cannot be recovered. | Back up or replicate objects separately and test object restoration. |
