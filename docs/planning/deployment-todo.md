...
- [ ] Validate the pilot scheduler cadence before live launch: payment initialization every 2 minutes and payment reconciliation every 5 minutes; outbox repair and lease recovery every 15 minutes; refund and withdrawal reconciliation hourly; invariant audit daily at 03:00 `Africa/Accra`.
