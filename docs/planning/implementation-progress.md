...
**Next slice:** add late-success fresh allocation and excess-payment refund
execution. Manual browser verification remains an explicit product-owner handoff.
