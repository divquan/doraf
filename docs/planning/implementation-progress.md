...
**Next slice:** Phase 5 withdrawal manual acceptance. Refund provider submission
and reconciliation remain deliberately deferred to the later exception slate.
...
| Phase 5 — Agent finance and portal                 | Partial               | Automated withdrawal concurrency, idempotent settlement, reversal, portal, and reconciliation checks pass; manual acceptance, notifications, and privacy-safe exports remain |
